...
public class TopicCommentController {
    ...
    public BaseResponse<PageDataDto<TopicCommentDto>> deleteTopicComment(@PathVariable Long topicCommentId) {
        Integer topicType = topicCommentService.deleteTopicComment(topicCommentId);
        return BaseResponse.success(CommonUtils.convertPageData(
                topicCommentService.getListTopicComment(topicType, PageRequest.of(0, 20, Sort.by("createdDate").descending()))
        ));
    }
